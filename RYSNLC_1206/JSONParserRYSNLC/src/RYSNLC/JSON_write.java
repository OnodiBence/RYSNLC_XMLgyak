		 ...
		 public static void main(String[] args)
		    {
		        ...
		        orak.add(addora(1,1,"Adatkezelés XML-ben", "Kedd", "12:00", "14:00", "XXXII A1 magasfsz", "Dr. Bednarik László","Programtervezõ Informatikus"));
		        orak.add(addora(1,2,"Adatkezelés XML-ben", "Szerda", "12:00", "14:00", "In/101 In I. e. 101", "Dr. Bednarik László","Programtervezõ Informatikus"));
		        
		        jsonRoot.put("ora", orak);
		        JSONObject jsonObject = new JSONObject();
		        jsonObject.put("orarendRYSNLC", jsonRoot);
		        
		        System.out.println(formatJSONStr(jsonObject.toJSONString(),2));
		        try
		        {
		        	FileWriter writer = new FileWriter("orarendRYSNLC.json");
